...
import RegistrationStapper from '@modules/registration/components/RegistrationStapper';
import RegistrationStep1 from '@modules/registration/components/RegistrationStep1';
import RegistrationStep2 from '@modules/registration/components/RegistrationStep2';
import RegistrationStep3 from '@modules/registration/components/RegistrationStep3';
...
const Registration = () => {
	...
	const handleStepNext = () => {
		setStepNumber((prevStep) =>
			prevStep < 4 ? ((prevStep + 1) as registrationSteps) : prevStep,
		);
	};
			...
			>
				{isSuccessStage ? (
					<p className={s.successStage}>
						ДЯКУЄМО, ваша інформація відправлена на обробку, очікуйте дзвінок від
